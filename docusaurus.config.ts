...
const config: Config = {
  ...
  customFields: {
    ...
    blogPost250727: process.env.BLOG_POST250727,
    blogPost250801: process.env.BLOG_POST250801,
    blogPost250806: process.env.BLOG_POST250806,
    blogPost250824: process.env.BLOG_POST250824,
    blogPost250919: process.env.BLOG_POST250919,
    blogPost250924: process.env.BLOG_POST250924,
    blogPost250929: process.env.BLOG_POST250929,
    blogPost251001: process.env.BLOG_POST251001,
    blogPost251004: process.env.BLOG_POST251004,
    blogPost251006: process.env.BLOG_POST251006,
    blogPost251010: process.env.BLOG_POST251010,
    blogPost251026: process.env.BLOG_POST251026,
  },
